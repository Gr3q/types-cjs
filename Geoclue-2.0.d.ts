...
declare namespace imports.gi.Geoclue {
	...
	interface IClient {
		 ...
		 * Since this D-Bus property is both readable and writable, it is meaningful to use this function on both the client- and service-side.
		 * 
		 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where #object was constructed. Use {@link Gclue.client_dup_desktop_id} if on another thread.
		 ...
		 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
		 * 
		 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where #object was constructed. Use {@link Gclue.client_dup_location} if on another thread.
		 * @returns The property value or %NULL if the property is not set. Do not free the returned value, it belongs to #object.
		 */
	...
	interface ILocation {
		 ...
		 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
		 * 
		 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where #object was constructed. Use {@link Gclue.location_dup_description} if on another thread.
		 * @returns The property value or %NULL if the property is not set. Do not free the returned value, it belongs to #object.
		 */
		 ...
		 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
		 * 
		 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where #object was constructed. Use {@link Gclue.location_dup_timestamp} if on another thread.
		 * @returns The property value or %NULL if the property is not set. Do not free the returned value, it belongs to #object.
		 */
